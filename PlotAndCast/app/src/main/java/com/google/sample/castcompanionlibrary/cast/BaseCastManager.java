...
public abstract class BaseCastManager implements DeviceSelectionListener, ConnectionCallbacks,
    ...
    /**
     * Sets the {@link android.content.Context} for the subsequent calls. Setting context can help the library to
...
public void onCastAvailabilityChanged(boolean castPresent) {
    ...
    /**
     * Returns the {@link android.support.v7.media.MediaRouteSelector} object.
     *
     * @return
     */
